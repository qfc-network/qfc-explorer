...
export default function LocaleSwitcher() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full z-50 mt-1 min-w-[140px] rounded-lg border border-slate-800 bg-slate-950 py-1 shadow-xl">
          {localeList.map(([code, name]) => (
            ...
            >
              ...
              <span>{name}</span>
              {locale === code && (
                <svg className="ml-auto h-3.5 w-3.5 text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
