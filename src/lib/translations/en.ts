const en = {
  ...
  'nav.nfts': 'NFTs',
  'nav.topNfts': 'Top NFTs',
  'nav.latestNftTransfers': 'Latest Transfers',
  'nav.latestNftMints': 'Latest Mints',
  ...
  'marketplace.submitTask': 'Submit Task',
  'marketplace.submitDescription': 'Pick a model, provide input data, and submit an AI inference task.',
  'marketplace.backToMarketplace': 'Back to Marketplace',
  'marketplace.selectModel': 'Select Model',
  'marketplace.modelRequirements': 'Model Requirements',
  'marketplace.inputData': 'Input Data / Prompt',
  'marketplace.inputPlaceholder': 'Enter your prompt or input data for the AI model...',
  'marketplace.maxFee': 'Max Fee',
  'marketplace.connectAndSubmit': 'Connect Wallet & Submit',
  'marketplace.submitting': 'Submitting...',
  'marketplace.myTasks': 'My Tasks',
  'marketplace.myTasksDescription': 'Track your submitted inference tasks and view results.',
  'marketplace.search': 'Search',
  'marketplace.loading': 'Loading...',
  'marketplace.totalSubmitted': 'Total Submitted',
  'marketplace.completedTasks': 'Completed',
  'marketplace.pendingTasks': 'Pending',
  'marketplace.avgExecTime': 'Avg Exec Time',
  'marketplace.taskId': 'Task ID',
  'marketplace.model': 'Model',
  'marketplace.status': 'Status',
  'marketplace.miner': 'Miner',
  'marketplace.fee': 'Fee',
  'marketplace.time': 'Time',
  'marketplace.noTasks': 'No tasks found for this address.',
} as const;
