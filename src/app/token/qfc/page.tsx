...
export const metadata: Metadata = {
  title: 'QFC Token',
  description: 'QFC native token supply and distribution.',
  openGraph: {
    title: 'QFC Token | QFC Explorer',
    description: 'QFC native token supply and distribution.',
    type: 'website',
  },
};
    ...
    <main className="mx-auto flex min-h-screen max-w-5xl flex-col gap-8 px-6 py-12">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-5">
          ...
          <p className="mt-2 text-lg text-slate-900 dark:text-white">{TOKENOMICS.decimals}</p>
        </div>
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-5">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Initial Supply</p>
          <p className="mt-2 text-lg text-slate-900 dark:text-white">{TOKENOMICS.initialSupply} QFC</p>
        </div>
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-5">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Max Supply</p>
          <p className="mt-2 text-lg text-slate-900 dark:text-white">{TOKENOMICS.maxSupply} QFC</p>
        </div>
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-5">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Block Reward</p>
          <p className="mt-2 text-lg text-slate-900 dark:text-white">{TOKENOMICS.blockReward} QFC</p>
        </div>
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-5">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Min Block Reward</p>
          <p className="mt-2 text-lg text-slate-900 dark:text-white">{TOKENOMICS.minBlockReward} QFC</p>
        </div>
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-5">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Halving Period</p>
          <p className="mt-2 text-lg text-slate-900 dark:text-white">{TOKENOMICS.halvingPeriodYears} year</p>
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-5">
          ...
          <p className="mt-2 text-lg text-slate-900 dark:text-white">{TOKENOMICS.minValidatorStake} QFC</p>
        </div>
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-5">
          <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Min Delegation</p>
          <p className="mt-2 text-lg text-slate-900 dark:text-white">{TOKENOMICS.minDelegation} QFC</p>
        </div>
      </div>
    </main>
  );
